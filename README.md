...
### 📊 UK Retail Sales Analysis (1988–2026)

**ETL + star-schema warehouse and BI analysis of the ONS UK Retail Sales Index**

PostgreSQL data modelling · SQL CTEs · Window functions · Star schema design · Power BI dashboard · DAX
...
**Multi-source retail ETL and exploratory analysis**

POS transactions · Online orders · Loyalty programme data · Data cleaning · Schema reconciliation · Interactive dashboards
...
**Data Analyst** — Siontec, Lagos, Nigeria · *Sep 2024 – Nov 2025*
- Analysed business data and built reporting for stakeholders
- Worked across SQL, Python, and BI tooling to turn raw data into decisions

**Developer Intern & Teaching Assistant** — Aptech Computer Education · *Jul 2023 – Sep 2024*
- Taught and mentored students in web development and Python
- Led weekly code review and debugging sessions
...
**I'm focused on turning data into useful insights that drive business decisions.**

Open to junior data analyst, graduate data, and business intelligence opportunities.
